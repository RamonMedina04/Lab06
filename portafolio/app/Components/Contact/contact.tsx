                ...
                <div className={styles.contact__content}>
                        ...
                        <div className={styles.contact__data}>
                            <div className={styles.contact__item}>
                                ...
                                <div className={styles.contact__text}>
                                    ...
                                    <a href="mailto:ramonmhdz04@gmail.com" className={styles.contact__value}>ramonmhdz04@gmail.com</a>
                                </div>
                            </div>
                            ...
                            <div className={styles.contact__item}>
                                ...
                                <div className={styles.contact__text}>
                                    ...
                                    <span className={styles.contact__value}>México, México</span>
                                </div>
                            </div>
                    ...
                    <div className={styles.contact__cta}>
                        <div className={styles.contact__card}>
                            ...
                            <a href="mailto:ramonmhdz04@gmail.com" className="btn btn--primary btn--large btn--full">
